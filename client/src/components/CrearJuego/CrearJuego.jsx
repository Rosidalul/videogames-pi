...
function CrearJuego(props) {
    ...
    const validate = form => {
        ...
        if (!form.name) {
            ...
            errors.name = 'El nombre del juego debe tener mas de 4 letras';
        }
        if (!form.description) {
            errors.description = 'Se requiere descripcion';
        } else if (form.description.length < 8) {
            errors.description = 'La descripcion debe tener una rango minimo de 8 caracteres'
        }
        if (!form.rating) {
            errors.rating = 'Se requiere Rating';
        } else if (!/^[1-5]$/.test(form.rating)) {
            errors.rating = 'El ratin solo puede ser de 1 a 5';
        }
        return errors;
    }
    ...
    const handleSubmit = e => {
        ...
        validate(form);
        let checkboxsErrors = []
        if (form.genres.length < 1) checkboxsErrors.push('Se requiere genero');
        if (form.platforms.length < 1) checkboxsErrors.push('Ingresa una plataforma');
    ...
    return (
        ...
        <div className="main-add">
            <div className="container-add">
                <h2>CREAR JUEGOS - DETALLES-</h2>
                <div className="div-cont">
                    <form onSubmit={handleSubmit} onChange={handleChange}>
                        <label htmlFor='name' className="title-name"><strong>NOMBRE: </strong></label>
                        <br />
                        <input className="name1" placeholder='Nombre' type="text" id='name' name='name' autoComplete="off"/>
                        <br />
                        <label htmlFor="description" className="title-name"><strong>DESCRIPCION: </strong></label>
                        <br />
                        <textarea className="name" name='description' placeholder='Descripcion' id="description" cols="30" rows="3" />
                        <br />
                        <label htmlFor="date" className="title-name"><strong>FECHA: </strong></label>
                        <br />
                        ...
                        <div id='genres' className="genres-div">
                            ...
                            <div>
                                ...
                                <label htmlFor="Strategy">Estrategias.</label>
                            </div>
                            <div>
                                <input name='Shooter' value='6' type="checkbox" id="Shooter" />
                                <label htmlFor="Shooter">Disparos.</label>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <label htmlFor="Simulation">Simulacion.</label>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <label htmlFor="Platformer">Plataformas.</label>
                            </div>
                            <div>
                                <input name='Racing' value='12' type="checkbox" id="Racing" />
                                <label htmlFor="Racing">Carreras.</label>
                            </div>
                            <div>
                                <input name='Massively-Multiplayer' value='13' type="checkbox" id="Massively-Multiplayer" />
                                <label htmlFor="Massively-Multiplayer">Multijugador.</label>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <label htmlFor="Fighting">Pelea.</label>
                            </div>
                        </div>
                        <label className="title-name"><strong>PLATAFORMAS: </strong> </label>
